...
//!
//! Wrapper of the DBus interface: [`org.freedesktop.portal.Background`](https://flatpak.github.io/xdg-desktop-portal/docs/index.html#gdbus-org.freedesktop.portal.Background).
//!
//! ### Examples
//!
//! ```rust,no_run
...
impl<'a> BackgroundProxy<'a> {
    ...
    /// # Specifications
    ///
    /// See also [`SetStatus`](https://flatpak.github.io/xdg-desktop-portal/docs/#gdbus-method-org-freedesktop-portal-Background.SetStatus).
